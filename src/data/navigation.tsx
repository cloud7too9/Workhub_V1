...
const StartPage = lazy(() => import('../pages/Start').then((m) => ({ default: m.Start })));
const HandbuchPage = lazy(() => import('../pages/Handbuch').then((m) => ({ default: m.Handbuch })));
const RechnerPage = lazy(() => import('../pages/Rechner').then((m) => ({ default: m.Rechner })));
const AuftraegePage = lazy(() => import('../pages/Auftraege').then((m) => ({ default: m.Auftraege })));
const EinstellungenPage = lazy(() => import('../pages/Einstellungen').then((m) => ({ default: m.Einstellungen })));
...
/** Routes shown as nav cards on the start page (excludes start itself) */
export function getStartNavItems(): NavRoute[] {
  return routes.filter((r) => r.showInSidebar && r.path !== '/');
}
