  ...
  return (
    ...
    >
      <div style={{ minWidth: 0 }}>
        ...
        {description && (
          <div style={{ fontSize: 11, color: tokens.muted, marginTop: 2 }}>{description}</div>
        )}
      </div>
      ...
      <div
        ...
        style={{
          ...
          height: 28,
          borderRadius: 999,
          background: checked ? tokens.accent : 'rgba(255,255,255,0.16)',
          border: `1px solid ${checked ? tokens.accent + '80' : 'rgba(255,255,255,0.14)'}`,
          cursor: 'pointer',
